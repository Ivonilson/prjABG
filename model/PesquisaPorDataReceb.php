...
class PesquisaPorDataReceb {
	...
	function pesquisaDataReceb()
	{
		...
		$querySelect = "SELECT cod_os, tipo, banco, empresa, proponente, cidade, observacoes, condominio, bairro, uf, data_receb, data_entrega, status, notas_importantes, ficha_pesquisa  FROM controle_demandas WHERE data_receb >= '$data_inicial' AND data_receb <= '$data_final'";
