...
<head>
	...
	<title>Histórico Item CARD/E-mail  <?=$historicoItem['item']?></title>
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">
					<mark class="p-2 rounded">Histórico Item CARD/E-mail</mark>
				</li>
			</ol>
			<div class="col bg-secondary">
				...
				<div class="container">
					...
					<div class="jumbotron jumbotron-fluid text-white text-center" style="background-color: #2F4F4F !important">
						<div class="container">
							<h4>Histórico Item CARD n° <?=$_GET['item-historico']?></h4>
						</div>
					</div>
					...
					<hr>
					<br> <span class="text-dark font-weight-bold">Item n°: <?=$historicoItem['item']?>
					<br><br>
